...
class PastAppointement extends Component {
  constructor(props) {
    super(props);
    ...
    getData = async()=>{
      console.log("paaaaaaaaaasssst      " , this.props.PastAppointements);
      this.setState({appointements : this.props.PastAppointements});
   ...
   async componentDidMount(){
    ...
    //  console.log("........... ",this.props.match.params.id )
     this.setState({ptId : this.props.ptId});
...
export default withStyles(useStyles)(PastAppointement); 
