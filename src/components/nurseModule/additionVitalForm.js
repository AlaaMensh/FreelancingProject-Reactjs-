      ...
      <Form>
        <Col sm={12}>
          ...
          />
            ...
            <Form.Group >
          {/* <Form.Label>{input.label || input.name} </Form.Label> */}
          <Form.Label>Blood Pressure Numerator</Form.Label>
          <Form.Control
            type={"number"}
            name="bloodPressureNumerator"
            placeholder={
              "enter the BloodPressure Numerator"
            }
            onChange={(e) => {
                this.props.handleChange(e);
            }}
        ...
        <Col sm={4}>
            <Form.Group >
          {/* <Form.Label>{input.label || input.name} </Form.Label> */}
          <Form.Label>Blood Pressure Demenator </Form.Label>
          <Form.Control
            type={"number"}
            name="bloodPressuredenomerator"
            placeholder={
              "enter the BloodPressure Demenator"
            }
            onChange={(e) => {
                this.props.handleChange(e);
            }}
        ...
        <Form.Label>OXSat</Form.Label>
          ...
          {/* <Form.Label>{input.label || input.name} </Form.Label> */}
            ...
            />
                ...
                <Col sm={2}>
                   <Row>
                    <span className="" style = {{marginBottom:" 0.6em"}}><h4>%</h4></span>
                   </Row>
                </Col>
            </Row>
