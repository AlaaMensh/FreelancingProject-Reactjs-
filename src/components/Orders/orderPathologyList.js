...
class OrderPathologyList extends Component {
  constructor(props) {
    super(props);
    ...
    getData = async()=>{
      var details = {
       ...
       await fetch(`http://localhost:3000/pathology/getOrdersBypathologyId`, {
         method: 'POST',
         headers: {
   ...
   async componentDidMount(){
    ...
    handleUpdate = ()=>{
      ...
      fetch('http://localhost:3000/pathology/updateOrder', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8'
        },
...
export default withStyles(useStyles)(OrderPathologyList); 