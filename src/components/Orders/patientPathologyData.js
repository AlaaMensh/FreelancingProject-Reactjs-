...
class PatientPathologyData extends Component {
  constructor(props) {
    super(props);
      ...
      const { todos } = this.state;
        return(
          ...
          <div className="container gridDataContent mt-5 "> 
            <div className="row mt-5 justify-content-center align-items-center borderedGrid  ">
  ...
  fetch('http://localhost:3000/pathology/setAccept', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8'
        },
      ...
      this.props.history.push("./orderPathologyList");
    }
...
export default withStyles(useStyles)(PatientPathologyData); 