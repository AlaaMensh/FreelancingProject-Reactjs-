...
class PatientRadioOrders extends Component {
  constructor(props) {
    super(props);
  ...
  fetch('http://localhost:3000/radio/setAccept', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8'
        },
      ...
      this.props.history.push("./orderRadioList");
    }
...
export default withStyles(useStyles)(PatientRadioOrders); 