...
return (
  <div className="row align-items-center justify-content-center bg-primary" style={{
    padding:"0" , margin:"0" , display:"flex" , height:"100%"}} >
    {/* <div className="" style={{width:"40px" , height:"40px" , backgroundColor:"brown"}}></div> */}
