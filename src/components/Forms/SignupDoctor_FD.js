...
export default function Signup() {
  ...
  const [contact_doctor, setContact_doctor] = useState();
  const classes = useStyles();
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            <TextField
              ...
              id="contact_doctor"
              onChange = {(event) =>{
                setContact_doctor(event.target.value);
                console.log("contact_doctor" , contact_doctor);
              }}
            />
          </Grid>
        </Grid>
