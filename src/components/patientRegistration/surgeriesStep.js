...
class SurgeriesStep extends Component {
  constructor(props) {
   ...
   async componentDidMount(){
     if(this.props.surgeriesListHome.length > 0 && this.props.surgeriesListHome.length ){
       this.setState({surgeriesList : this.props.surgeriesListHome , key:this.props.surgeriesListHome.length+1})
     }
      // this.getData()
    ...
    handleUpdate = ()=>{
      ...
      var details = {
        ...
        surgery: this.state.type,
        date: this.state.status,
        notes: this.state.notes,
      }

      if(!details.surgery){
        details.surgery = this.state.TypeObj.surgery
      }
      if(!details.date){
      ...
      if(!details.notes){
        ...
        const items = this.state.surgeriesList.map(
        ...
        return(
          ...
          <div className="row">
            ...
            <div className = "row gridDataHeader align-items-center" style={{ height: 400, width: '100%' }}>
               <DataGrid className="datagrid bg-light  rounded MuiDataGrid-cellCenter" style={{textAlign:"center"}} rows={this.state.surgeriesList} columns={[
                 { field: 'id', headerName: 'id', width: 70 },
              { field: 'surgery', headerName: 'Srugery', width: 200 },
                ...
                <div className={classes.paper}>
                    ...
                    <Grid container spacing={2}>
                        ...
                        InputProps={{ classes: { input: this.props.classes.input2 } }}
                            ...
                            type="text"
                            autoComplete="Type"
                            placeholder={this.state.TypeObj.surgery}
                            onChange = {(event) =>{
