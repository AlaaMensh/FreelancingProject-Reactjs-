...
class OnGoingProblemStep extends Component {
  constructor(props) {
   ...
   async componentDidMount(){
     if(this.props.onGoingProblemListHome.length > 0 && this.props.onGoingProblemListHome.length ){
       this.setState({onGoingProblemList : this.props.onGoingProblemListHome , key:this.props.onGoingProblemListHome.length+1})
     }
      // this.getData()
        ...
        return(
          ...
          <div className="row">
            <div className="col-auto px-2 py-2 text-center rounded  header">
                <span className="">On Going Problems</span>
            </div>
            ...
            <div className = "row gridDataHeader align-items-center" style={{ height: 400, width: '100%' }}>
               <DataGrid className="datagrid bg-light  rounded MuiDataGrid-cellCenter" style={{textAlign:"center"}} rows={this.state.onGoingProblemList} columns={[
                 { field: 'id', headerName: 'id', width: 70 },
              { field: 'problem', headerName: 'Problem', width: 200 },
              { field: 'diagnosisDate', headerName: 'Diagnosis Date', width: 200 },
